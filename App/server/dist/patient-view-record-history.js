...
const get_patient_history_1 = __importDefault(require("./handlers/get-patient-history"));
const get_patient_prescription_1 = __importDefault(require("./handlers/get-patient-prescription"));
exports.default = {
    execute: (connection, patient_id, doctor_id, presdate) => __awaiter(void 0, void 0, void 0, function* () {
        const patientInfo = yield get_patient_info_1.default.execute(connection, patient_id);
        const patientHistory = yield get_patient_history_1.default.execute(connection, patient_id);
        const patientPrescriptions = yield get_patient_prescription_1.default.execute(connection, doctor_id, patient_id, presdate);
        const patient = { info: patientInfo, history: patientHistory, prescription: patientPrescriptions };
        return patient;
    })
};
