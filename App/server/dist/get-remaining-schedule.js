...
exports.default = {
    execute: (connection, doctor_id) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const result = yield (yield connection).query(`SELECT * FROM (select a.time, p.patient_id, p.last_name, p.first_name from public.patient p natural join public.appointment a
